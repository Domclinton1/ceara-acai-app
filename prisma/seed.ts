...
const main = async () => {
  await prismaClient.$transaction(async (tx: any) => {
    ...
    const restaurant = await tx.restaurant.create({
      data: {
        name: "CearAçaí Burguer",
        slug: "ceara-app",
        description: "O melhor açaí de Belo Horizonte",
        avatarImageUrl: "/images/logo.webp",
      ...
      data: [
        {
          ...
          price: 14.0,
          imageUrl: "/images/creme-cearacai-500ml.webp",
        ...
        },
        {
          ...
          price: 22.0,
          imageUrl: "/images/creme-acai-casado.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
          ingredients: [
            "Creme de açaí",
        ...
        },
        {
          ...
          price: 23.0,
          imageUrl: "/images/creme-acai-ovomaltine-calda-morango.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
        ...
        },
        {
          ...
          price: 23.0,
          imageUrl: "/images/creme-acai-salada-de-frutas.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
          ingredients: [
            "Creme de açaí",
        ...
        },
        {
          ...
          price: 23.9,
          imageUrl: "/images/creme-acai-kids.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
        ...
        },
        {
          ...
          price: 22.0,
          imageUrl: "/images/creme-sensacao.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
          ingredients: [
            "Creme de açaí",
        ...
        },
        {
          ...
          price: 23.9,
          imageUrl: "/images/creme-acai-bis.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
          ingredients: [
            "Creme de açaí",
        ...
        },
        {
          ...
          price: 29.9,
          imageUrl: "/images/creme-acai-super-nutella.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
          ingredients: [
            "Creme de açaí",
        ...
        },
        {
          ...
          price: 24.9,
          imageUrl: "/images/creme-morango.webp",
          menuCategoryId: acaiCategory.id,
          restaurantId: restaurant.id,
      ...
      data: [
        {
          ...
          price: 9,
          imageUrl: "/images/misto-quente.webp",
        ...
        },
        {
          ...
          price: 11.5,
          imageUrl: "/images/hamburguer.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 11.5,
          imageUrl: "/images/x-burguer.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          price: 15,
          imageUrl: "/images/x-bacon-burguer.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 15,
          imageUrl: "/images/x-egg-burguer.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 15.5,
          imageUrl: "/images/x-egg-burguer-especial.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          price: 16,
          imageUrl: "/images/x-calabresa.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          price: 16,
          imageUrl: "/images/x-picanha.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 16,
          imageUrl: "/images/x-picanha-especial.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 16,
          imageUrl: "/images/framburguer.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 16,
          imageUrl: "/images/framburguer-especial.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 16,
          imageUrl: "/images/big-frango.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 16.5,
          imageUrl: "/images/frango-desfiado.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          price: 18,
          imageUrl: "/images/frango-com-catupiry.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 19,
          imageUrl: "/images/filé-com-catupiry.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          price: 15.5,
          imageUrl: "/images/ceará-burguer.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 16,
          imageUrl: "/images/ceara-burguer-3-em-1.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 19,
          imageUrl: "/images/ceara-burguer-4x4.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 18,
          imageUrl: "/images/vegetariano.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 23,
          imageUrl: "/images/duplo-picanha.webp",
          menuCategoryId: hamburguersCategory.id,
          restaurantId: restaurant.id,
        },
      ],
      ...
      data: [
        {
          ...
          price: 17,
          imageUrl: "/images/espaguete-a-bolonhesa-peq.webp",
        ...
        },
        {
          ...
          ingredients: ["Macarrão", "Queijo", "Molho a Bolonhesa"],
          price: 21,
          imageUrl: "/images/espaguete-a-bolonhesa-grd.webp",
          menuCategoryId: espagueteCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 15,
          imageUrl: "/images/espaguete-na-chapa-peq.webp",
          menuCategoryId: espagueteCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 19,
          imageUrl: "/images/espaguete-na-chapa-grd.webp",
          menuCategoryId: espagueteCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 25,
          imageUrl: "/images/big-espaguete-na-chapa.webp",
          menuCategoryId: espagueteCategory.id,
          restaurantId: restaurant.id,
        },
      ],
    ...
    await tx.product.createMany({
      data: [
        ...
        },
        {
          ...
          price: 24,
          imageUrl: "/images/omelete-especial.webp",
          menuCategoryId: omeleteCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 22,
          imageUrl: "/images/omelete-com-cheddar.webp",
          menuCategoryId: omeleteCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 22,
          imageUrl: "/images/omelete-com-catupiry.webp",
          menuCategoryId: omeleteCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          price: 22,
          imageUrl: "/images/omelete-tropical.webp",
          menuCategoryId: omeleteCategory.id,
          restaurantId: restaurant.id,
        },
      ],
      ...
      data: [
        {
          ...
          ingredients: [],
          price: 20,
          imageUrl: "/images/fritas-400gr.webp",
        ...
        },
        {
          ...
          ingredients: [],
          price: 24,
          imageUrl: "/images/fritas-com-queijo.webp",
          menuCategoryId: porcoesCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 27,
          imageUrl: "/images/fritas-bacon-cheddar.webp",
          menuCategoryId: porcoesCategory.id,
          restaurantId: restaurant.id,
        },
      ],
    ...
    await tx.product.createMany({
      data: [
        ...
        },
        {
          ...
          ingredients: [],
          price: 6,
          imageUrl: "/images/schweppes-350ml.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 9,
          imageUrl: "/images/heineken-latao.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 6.5,
          imageUrl: "/images/brahma-latao.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 5,
          imageUrl: "/images/kaiser-latao.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 6.5,
          imageUrl: "/images/skol-latao.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          ingredients: [],
          price: 2.5,
          imageUrl: "/images/agua-500ml.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          ingredients: [],
          price: 8,
          imageUrl: "/images/h20-500ml.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 8,
          imageUrl: "/images/agua-tonica.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 3,
          imageUrl: "/images/refir-200ml.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 8,
          imageUrl: "/images/mate-couro-1l.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 10,
          imageUrl: "/images/coca-cola-2l.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
        ...
        },
        {
          ...
          ingredients: [],
          price: 12,
          imageUrl: "/images/guarana-antartica.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 10,
          imageUrl: "/images/fanta-laranja.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
        {
          ...
          ingredients: [],
          price: 10,
          imageUrl: "/images/sukita-laranja.webp",
          menuCategoryId: drinksCategory.id,
          restaurantId: restaurant.id,
        },
      ],
